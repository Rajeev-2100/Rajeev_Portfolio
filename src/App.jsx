...
const projects = [
  {
    ...
    tech: ["React", "Bootstrap", "Node.js", "Express.js", "MongoDB", "Mongoose", "REST APIs", "Context API", "JWT", "bcrypt", "Authentication", "Landing Page", "Chart.js"],
    codeUrl: "https://github.com/Rajeev-2100/workasana_FE",
    demoUrl: "https://workasana-fe.vercel.app/",
    src_Image: workAsana, // Fixed mapping
  },
  {
    title: "SmartLead CRM",
    ...
    tech: ["React", "Bootstrap", "React Router", "Node.js", "Express.js", "MongoDB", "Mongoose", "JWT", "Authentication", "Landing Page", "Chart.js"],
    codeUrl: "https://github.com/Rajeev-2100/SmartLeadCRM_Frontend.git",
    demoUrl: "https://smartlead-crm-frontend-r78f.vercel.app/",
    src_Image: crmApplication, // Fixed mapping
  },
  {
    title: "Modern Mart",
    ...
    tech: ["React", "Vite", "Bootstrap", "React Router", "Node.js", "Express.js", "MongoDB", "Mongoose", "JWT", "Authentication", "Landing Page"],
    codeUrl: "https://github.com/Rajeev-2100/ModernMart_Frontend.git",
    demoUrl: "https://modernmart-ecommerce-frontend.vercel.app/",
    src_Image: ecommerce, // Fixed mapping
  },
];
    ...
    <div className="portfolio-root">
      ...
      <nav className={`navbar ${scrolled ? "scrolled" : ""}`}>
        <div className="nav-container">
          ...
          <div className="desktop-nav">
            {["home", "projects", "skills", "contact"].map((s) => (
              <a key={s} href={`#${s}`} onClick={(e) => { e.preventDefault(); scrollTo(s); }} className="nav-link">
                {s}
              </a>
            ))}
            <a href="https://rajeevrawat2100.hashnode.dev/" target="_blank" rel="noopener noreferrer" className="nav-blog-btn">
              Blog
            </a>
          </div>

          <button onClick={() => setNavOpen(!navOpen)} className="hamburger" aria-label="Toggle navigation">
            {navOpen ? "✕" : "☰"}
          </button>
        </div>
        ...
        {navOpen && (
          <div className="mobile-nav">
            {["home", "projects", "skills", "contact"].map((s) => (
              <a key={s} href={`#${s}`} onClick={(e) => { e.preventDefault(); scrollTo(s); }} className="nav-link mobile">
                {s}
              </a>
            ))}
          </div>
        ...
        <div className="hero-container">
          <div className="hero-content">
            ...
            <p className="hero-subtitle">
              I'm a Full Stack Engineer specializing in the MERN stack. I architect secure, scalable web applications—from CRMs and e-commerce platforms to productivity dashboards. Let's turn complex logic into seamless user experiences.
            </p>
          ...
          {/* NEW UNIQUE VISUAL: IDE CONFIG CARD */}
          <div className="hero-visual">
            <div className="ide-card">
              <div className="ide-header">
                ...
                <span className="ide-filename">developer.config.js</span>
              </div>
              <div className="ide-body">
                <div className="code-line"><span className="line-num">1</span> <span className="code-keyword">const</span> <span className="code-var">developer</span> <span className="code-operator">=</span> {'{'}</div>
                <div className="code-line"><span className="line-num">2</span>   <span className="code-prop">name</span>: <span className="code-string">'Rajeev Rawat'</span>,</div>
                <div className="code-line"><span className="line-num">3</span>   <span className="code-prop">stack</span>: [<span className="code-string">'MongoDB'</span>, <span className="code-string">'Express'</span>, <span className="code-string">'React'</span>, <span className="code-string">'Node'</span>],</div>
                <div className="code-line"><span className="line-num">4</span>   <span className="code-prop">focus</span>: <span className="code-string">'Scalable UI & Secure APIs'</span>,</div>
                <div className="code-line"><span className="line-num">5</span>   <span className="code-prop">auth</span>: <span className="code-string">'JWT & Context API'</span>,</div>
                <div className="code-line"><span className="line-num">6</span>   <span className="code-prop">available</span>: <span className="code-boolean">true</span></div>
                <div className="code-line"><span className="line-num">7</span> {'}'};</div>
                <div className="code-line"><span className="line-num">8</span>&nbsp;</div>
                <div className="code-line"><span className="line-num">9</span> <span className="code-keyword">export default</span> <span className="code-var">developer</span>;</div>
              </div>
            </div>
            ...
            {projects.map((p) => (
              <div key={p.title} className="project-card">
                <div className="project-img-wrap">
                  <img src={p.src_Image} alt={`${p.title} interface screenshot`} loading="lazy" />
                </div>
                  ...
                  <div className="tech-tags">
                    {p.tech.map((t) => (
                      <span key={t} className="tech-tag">
                        {techIconMap[t] && <span className="tag-icon">{techIconMap[t]}</span>}
                        {t}
                      </span>
                    ))}
                  </div>
                  <div className="project-links">
                    <a href={p.demoUrl} target="_blank" rel="noopener noreferrer">👁 Live Demo</a>
                    <a href={p.codeUrl} target="_blank" rel="noopener noreferrer">&lt;/&gt; Source</a>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section id="skills" className="section">
        <div className="section-container">
          ...
          <p className="section-subtitle">Tools I use to ship production-ready applications</p>
          <div className="section-divider" />
      ...
      <section id="contact" className="section">
        <div className="section-container">
          ...
          <p className="section-subtitle">Open to collaborations, freelance work, or full-time roles</p>
          <div className="section-divider" />

          <div className="contact-grid">
            {[
              { icon: "✉", label: "Email", value: "rajeevrawat210@gmail.com", href: "mailto:rajeevrawat210@gmail.com" },
              { icon: "⬡", label: "GitHub", value: "View repositories", href: "https://github.com/Rajeev-2100" },
              { icon: "in", label: "LinkedIn", value: "Connect professionally", href: "https://www.linkedin.com/in/rajeev-rawat-956934225/" },
              { icon: "🐦", label: "Twitter", value: "Follow updates", href: "https://x.com/RajeevR57005639" },
            ].map((c) => (
      ...
      <footer className="footer">
        <p>© {new Date().getFullYear()} Rajeev Rawat • Built with React, Node.js & ❤️</p>
      </footer>

      {/* SCROLL TO TOP */}
      <button onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })} className="scroll-top" aria-label="Back to top">
        ↑
      </button>
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-grid-bg {
          position: absolute; inset: 0; opacity: 0.12; z-index: 0; pointer-events: none;
          background-image: linear-gradient(rgba(34,197,94,0.3) 1px, transparent 1px),
        ...
        .hero-spotlight {
          ...
          background: radial-gradient(600px circle at var(--x,50%) var(--y,50%), rgba(34,197,94,0.07), transparent 40%);
        }
        ...
        .status-badge {
          ...
          color: var(--accent); margin-bottom: 32px; backdrop-filter: blur(10px);
        }
        ...
        .bento-card {
          background: rgba(255,255,255,0.03); border: 1px solid #1a1a1a; border-radius: 14px;
        ...
        /* IDE CARD STYLES */
        .ide-card {
          background: #0a0a0a; border: 1px solid #1e1e1e; border-radius: 12px; overflow: hidden;
          box-shadow: 0 20px 60px rgba(0,0,0,0.6), 0 0 0 1px rgba(34,197,94,0.08);
          backdrop-filter: blur(20px); width: 100%; max-width: 420px;
        }
        .ide-header {
          background: #111; padding: 14px 18px; display: flex; align-items: center;
        ...
        .float-badge {
          position: absolute; background: #111; border: 1px solid #222; border-radius: 12px;
        ...
        .scroll-indicator {
          ...
          display: flex; flex-direction: column; align-items: center; gap: 8px; opacity: 0.4; z-index: 2;
        }
